...
2. Vertel welke domeinnaam jij gekozen hebt en hoe je die hebt gekoppeld aan jouw pagina.
    Ik heb punkyfis gekozen en deze heb ik gekoppeld met de instructies op DLO, het is nog niet helemaal gelukt maar dat komt omdat ik de nieuwe DNS nog moet laten laden. Het kan 24 uur duren zeggen ze.
